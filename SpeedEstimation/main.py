...
import de.networks
from de.layers import disp_to_depth
from de.utils import download_model_if_doesnt_exist

from od.models.experimental import attempt_load
from od.utils.datasets import LoadStreams, LoadImages
from od.utils.general import check_img_size, check_requirements, check_imshow, non_max_suppression, apply_classifier, \
    scale_coords, xyxy2xywh, strip_optimizer, set_logging, increment_path, save_one_box
from od.utils.plots import colors, plot_one_box
...
def detect(weights='yolov5s.pt',  # model.pt path(s)
    ...
    encoder = de.networks.ResnetEncoder(18, False)
    ...
    depth_decoder = de.networks.DepthDecoder(
